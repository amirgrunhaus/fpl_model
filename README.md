...
**There's some extra data in the directory, however, the data specified above is the most relevant and what we'll use for our model.*

I'm currently working in new notebooks and models and will be updating the repository weekly.
